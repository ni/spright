...
const destinationDirectory = path.resolve(__dirname, '../SprightBlazorArmstrong/wwwroot');
console.log(`Destination directory for blazor assets: "${destinationDirectory}"`);

const sprightComponentsPath = resolvePackagePath('@ni/spright-components-armstrong');
...
prepareDestinationDirectory('spright-components-armstrong');
copyFiles(componentsSrc, componentsBasePath, 'spright-components-armstrong');
